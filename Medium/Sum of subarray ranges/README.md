<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-subarray-ranges/1?page=2&difficulty[]=1&category[]=Stack&sortBy=submissions">Sum of subarray ranges</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer array <strong>a</strong><strong>rr&nbsp;</strong>of size <strong>N</strong>.&nbsp;The <strong>Range</strong> of a subarray of arr is the difference between the largest and smaller element in the subarray.&nbsp;&nbsp;<br>
