<h2><a href="https://practice.geeksforgeeks.org/problems/gray-code4907/1?page=2&difficulty[]=-1&category[]=Bit%20Magic&sortBy=submissions">Gray Code</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given a decimal number <strong>n. </strong>You need to find the gray code of the number n and convert&nbsp;it into decimal.</span></p>
