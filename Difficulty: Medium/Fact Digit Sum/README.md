<h2><a href="https://www.geeksforgeeks.org/problems/fact-digit-sum4125/1?page=1&difficulty=Medium&status=unsolved&sortBy=submissions">Fact Digit Sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">A(X) for positive integer X&nbsp;is the&nbsp;sum of factorials of its digits. For example, A(154) = 1! + 5! + 4!= 145.</span><br>
