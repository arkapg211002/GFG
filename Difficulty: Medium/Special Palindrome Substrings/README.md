<h2><a href="https://www.geeksforgeeks.org/problems/special-palindrome-substrings--170647/1?page=1&difficulty=Medium&status=unsolved&sortBy=submissions">Special Palindrome Substrings</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings s1 and s2, The task is to convert s1 into a palindrome such that s1 contain s2 as a substring in a minimum number of operation.<br>
